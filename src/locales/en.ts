...
export const en = {
  ...
  easyRainbowVariant: "Easy rainbow",
  ...
  easyRainbowVariantDescription: "A 6th suite is added that matches every color",
  ...
  variantDoesNotSupportAi: "The AI isn't working properly on this mode yet",
