...
export const en = {
  ...
  positiveHintNumberSequence: "Your card {{ position }} is a {{ number }} or more",
  positiveHintColorPlural: "Your cards {{ positions }} are {{ color }}",
  positiveHintNumberPlural: "Your cards {{ positions }} are {{ number }}s",
  positiveHintNumberSequencePlural: "Your cards {{ positions }} are {{ number }}s or more",
  you: "You",
  hinted: "Hinted",
  played: "Played",
  discarded: "Discarded",
  ...
  abort: "Abort",
  receivedHintTurnYourself: "hinted you about ",
  hintedTurn: "hinted ",
  hintedTurnYourself: "hinted ",
  discardedTurn: "discarded ",
  discardedTurnYourself: "discarded ",
  playedTurn: "played ",
  playedTurnYourself: "played ",
  cardDrawnTurn: "& drew ",
  cardDrawnTurnYourself: "& drew ",
  aboutTurn: "about ",
  aboutTurnYourself: "about ",
  pluralTurn: "s",
  ...
  playHints: "Average plays per hint",
  playerHints: "Who gave the most hints?",
  tryOutTitle: "Try it out!",
  tryOutButton: "Try this shuffle",
  tryOutAlternative: "You can also play with other setups and meet our AI on",
  back: "Back",
