...
export const nl = {
  ...
  invitationByPlayers: "{{playerNames}} heeft je uitgenodigd voor een spel Hanabi 🎉",
  invitationByPlayers_plural: "{{playersNames}} hebben je uitgenodigd voor een spel Hanabi 🎉",
