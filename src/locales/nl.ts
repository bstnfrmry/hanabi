...
export const nl = {
  ...
  abort: "Afbreken",
  receivedHintTurnYourself: "heeft jou een tip gegeven over ",
  hintedTurn: "gaf een tip aan ",
  hintedTurnYourself: "gaf een tip aan ",
