...
export const ru = {
  ...
  publicRepo: "Также у нас есть <1>публичный репозиторий Github</1>, на случай если вы захотите помочь или сообщить об ошибке.",
  ...
  playHints: "Среднее количесвтво сыгранных карт на одну подсказку: <1>{{playsPerHint}}</1>",
  playerHints: "Кто дал больше всего подсказок?",
  tryOutTitle: "Попробуйте!",
  tryOutButton: "Попробовать эту раздачу",
  tryOutAlternative: "Вы также можете сыграть с другими настройками или с нашим ИИ на <1>hanabi.cards</1>",
  back: "Назад",
