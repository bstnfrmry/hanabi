...
export const ru = {
  ...
  subTagline:
    "Кооперативная многопользовательская карточная игра доступная на телефоне, планшете и компьютере",
  ...
  discardPile: "сбросить ({{ discardLength }})",
  ...
  go: "Вперед!",
  estimatedMaxScore:
    "Предполагаемый максимальный счет для этой раздачи: {{reachableScore}}.",
  ...
  positiveHintNumberSequence:
    "Цифра на карте {{ position }} - {{ number }} или выше",
  positiveHintColorPlural: "Цвет карт {{ positions }} - {{ color }}",
  positiveHintNumberPlural: "На картах {{ positions }} цифра {{ number }}",
  positiveHintNumberSequencePlural:
    "На картах {{ positions }} цифра {{ number }} или выше",
  you: "Вы",
  hinted: "Подсказал",
  played: "Сыграл",
  discarded: "Сбросил",
  ...
  earlyDevelopment:
    "Игра все еще в ранней стадии разработки и мы очень ценим обратную связь.",
  publicRepo:
  ...
  sequenceVariantDescription:
    "Подсказки о цифре говорят и о картах с цифрой выше",
  showDirectHints: "Показывать прямые подсказки",
  hideDirectHints: "Не показывать прямые подсказки",
  botSpeed: "Скорость ботов",
  normalGameExplanation:
    "Вы сможете играть по интернету поделившись ссылкой со своими друзьями.",
  ...
  privateSubtext:
    "Вашу игру не будет видно в разделе 'Присоедениться к комнате'",
  ...
  objective: "Цель",
  rulesIntro:
    "Ханаби это карточная игра созданная Антуаном Боза. Она кооперативная, а значит игроки играют не друг против друга, а обьединены общей целью. Они предстают в роли пиротехников, которые по невниматльности смешали свой порох, фители и заряды, готовясь к большому шоу фейерверков. Шоу скоро начнётся, а вокруг происходит хаос. Теперь они должны помочь друг-другу что бы не дать превратиться шоу в сплошное разочарование.",
  rulesGoal:
    "Цель команды пиротехников - собрать 5 фейерверков, по одному каждого цвета (белый, красный, синий, желтый, зеленый) разыгрывая карты возрастающей ценности (1,2,3,4,5) одного цвета.",
  rulesSetupTitle: "Подготовка",
  rulesSetup:
    "Это чудесное приложение сделает всю подготовку к игре за вас 😉. В начале игры у вас будет 8 синих жетонов - подсказок - и 3 красных жетона - это жетоны наказания.\n\nКолода состоит из 50 карт, по 10 каждого цвета <1> с цифрами 1, 1, 1, 2, 2, 3, 3, 4, 4, 5</1>.\n· Если игроков 2 или 3, то каждому игроку раздается по 5 карт\n· Если игроков 4 или 5, то каждому игроку раздается по 4 карты.\n\nИгроки не могут смотреть на свои карты!",
  rulesGameTitle: "Ход игры",
  rulesGame:
    "Каждый игрок в свой ход выполняет ровно одно из трех следующих действий. Пропустить ход нельзя.\n\n1. Дать информацию другому игроку.\n2. Сбросить карту.\n3. Сыграть карту.\n\n Игроки не могут делиться подсказками и идеями в ход другого игрока.",
  ...
  rulesPlay:
    "В ваш ход Вы можете разыграть карту из руки.\nДалее происходиь одно из двух:\n· Если карта начинает или продолжает фейерверк, она будет добавлена в стопку этого фейерверка\n· Если карта не подходит к фейерверку, она будет сброшена и вам добавится жетон ошибки\nПосле этого вы вытяните новую карту из колоды.\n\nКогда игрок заканчивает фейерверк разыгрывваю карту с цифрой 5 на ней, команда получает один бонусный синий жетон. Если все синие жетоны уже у вас, то бонуса вы не получите.",
  rulesEndTitle: "Конец игры",
  rulesEnd:
    "Существует 3 варианта окончания игры Ханаби:\n· Если вы собираете три красных жетона, то игра тут же заканчивается!\n· Если вы полностью собираете все фейерверки, то игра заканчивается невероятным представлением и команда набирает максимальное количество очков!\n· Если игрок вытягивает последнюю карту из колоды, то игра вот-вот закончится. Каждый игрок соверашает еще по одному ходу. В течении этих ходов игроки больше не берут карты.\n\nПотом подсчитываются очки, основываясь на том, какие фейерверки получились у игроков.",
  rulesExtensionTitle: "Дополнения",
  rulesExtensionMulticolor:
    "🎨 Разноцветный вариант добавляет 6-ой тип карт, в котором есть по одной карте каждого значения: 1, 2, 3, 4, 5. Эти фейерверки более редки и вам стоит сбрасывать их наиболее аккуратно. Все правила те же, и вам нужно собрать 6 кучек, чтобы добиться максимального счета: 30 очков.",
  rulesExtensionRainbow:
    "🌈 Радужное дополнение также добавляет 6-ой тип карт с теми же значениями (три 1, по две 2/3/4 и одна 5). Особенность радужных карт в том, что они всех цветов сразу. Каждый раз когда вы даете подсказку о цвете это затронет и их.",
  rulesUsTitle: "Кто мы?",
  rulesUs:
    "Мы группа любителей настольных игр. Во время самоизоляции в 2020, мы хотели найти альтернативный способ играть удаленно.\nТак как программирование и игра в Ханаби доставляет нам удовольствие, мы решили создать онлайн версию игры, которая бы работала на мобильнх девайсах.\n\n👉 Если вам нравится игра, приобретите <2>физическию версию</2> чтобы поддержать ее создателя!",
  rulesBuy:
  ...
  evolution: "Эволюция",
  evolutionSubtext:
    "Следи за историей игры! Каждая карта помечена, можно ли было ее сыграть, сбросить или она являлась опасной (она понизит максимальный возможный счет если вы ее сбросите, например разноцветная или 5).",
  playerActions: "Среднее количество действий на игрока",
  playHints:
    "Среднее количесвтво сыгранных карт на одну подсказку: <1>{{playsPerHint}}</1>",
  playerHints: "Кто дал больше всего подсказок?",
  tryOutTitle: "Попробуйте!",
  tryOutButton: "Попробовать эту раздачу",
  tryOutAlternative:
    "Вы также можете сыграть с другими настройками или с нашим ИИ на <1>hanabi.cards</1>",
  back: "Назад",
