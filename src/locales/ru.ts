...
export const ru = {
  ...
  playHints:
    "Среднее количество сыгранных карт на одну подсказку: <1>{{playsPerHint}}</1>",
  playerHints: "Кто дал больше всего подсказок?",
  tryOutTitle: "Попробуйте!",
  tryOutButton: "Попробовать эту раздачу",
  tryOutAlternative:
    "Вы также можете сыграть с другими настройками или взять в команду наш ИИ на <1>hanabi.cards</1>",
  back: "Назад",
