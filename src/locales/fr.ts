...
export const fr: typeof en = {
  ...
  abort: "Retour au jeu",
  receivedHintTurnYourself: "t'a donné un indice sur tes ",
  hintedTurn: "a donné un indice à ",
  hintedTurnYourself: "as donné un indice à ",
  discardedTurn: "a défaussé son ",
  discardedTurnYourself: "as défaussé ton ",
  playedTurn: "a joué son ",
  playedTurnYourself: "as joué ton ",
  cardDrawnTurn: "et a pioché le ",
  cardDrawnTurnYourself: "et as pioché le ",
  aboutTurn: "sur ses ",
  aboutTurnYourself: "sur tes ",
  ...
  summary: "Sommaire",
  summarySubtitle: "Notre jeu Hanabi",
  shuffle: "Série",
  gameCompleted: "Jeu terminé en {{ gameDuration }}",
  result: "Notre résultat",
  evolution: "Évolution",
  evolutionSubtext:
    "Suivez le déroulement du jeu! La carte de chaque joueur est affichée, qu'elle soit jouable, jetable ou dangereuse (une carte qui fera baisser votre score maximum possible si vous la défaussez, par exemple un multicolore ou un 5).",
  playerActions: "Actions moyennes par joueur",
  playHints: "Nombre moyen de cartes jouées par indice",
  playerHints: "Qui a donné le plus d'indices?",
  tryOutTitle: "Essaye le!",
  tryOutButton: "Essayez cette série",
  tryOutAlternative: "Tu peux également jouer avec d'autres configurations et rencontrer notre IA sur",
  back: "Retour",
  statsPlayable: "jouable",
  statsDiscardable: "jetable",
