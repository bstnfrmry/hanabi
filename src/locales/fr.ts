...
export const fr: typeof en = {
  ...
  discard: "défausse ({{ discardLength }})",
  ...
  turnsLeftDisclaimer: "· {{game.actionsLeft}} tours restant",
  ...
  selectVignette: "Sélectionner une couleur ou une valeur pour donner un indice",
  hint: "Annoncer",
  ...
  positiveHintNumberPlural: "Tes cartes {{ positions }} sont des {{ number }}s",
  you: "Vous", // TODO check
  hinted: "Indices",
  ...
  hideDirectHints: "Ne pas montrer les déductions",
