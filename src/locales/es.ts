...
export const es = {
  ...
  learnHanabiEnglish: "Esta sección está en desarrollo y aún no ha sido traducida a todos los idiomas.",
  learnWhileWaiting: "Aprende lo básico de Hanabi mientras esperas",
};
