...
export default function BuymeacoffeeButton(props: { className: string }) {
  return (
    <>
      <Head>
      ...
      <a
        className={"bmc-button db " + props.className}
      ...
      >
        ...
        <span style={{ marginLeft: "5px", fontSize: "24px" }}>Buy us a coffee</span>
        <style jsx>
          {`
            .bmc-button img {
              height: 34px;
