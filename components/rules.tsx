...
const Rules = ({ setShowRules }: Props) => (
  <div className="fixed bg-black z-9999 aspect-ratio--object overflow-y-scroll flex justify-center pa4 relative tj lh-copy">
    <div className="w-75-l pv4">
      <Button
      ...
      <div className="flex flex-column">
        ...
        <Txt className="txt-yellow" size={TxtSize.MEDIUM} value="Objective" />
        <Txt
          className="mv2"
        ...
        />
        <Txt className="mv2">
          The goal of the pyrotechnics team is to build 5 fireworks, one of each
          color (white, red, blue, yellow, green) by combining increasing value
          cards (1,2,3,4,5) of the same color.
          <br />
        ...
        <Txt className="mv2">
          ...
          beginning of a game, you will have 8 blue tokens - your hints - and 3
          red tokens - your strike tokens.
          <br />
        ...
        />
        <Txt className="mv2">
          On each player&lsquo;s turn, they take one (and only one) of the three
        ...
        <Txt className="mv2">
          ...
          must pick a different action. <br />
          You then give information to a fellow player about the cards in that
          player&lsquo;s hand by clicking on it. You can tell the player either
        ...
        <Txt className="mv2">
          ...
          hand by tapping it. You then draw a new card from the deck and it will
          be added to your hand.
          <br />
          Note: If you have all 8 blue tokens, you cannot discard cards and must
          pick a different action.
          <br /> You can consult discarded cards by clicking on the grey deck
        </Txt>
        ...
        <Txt className="mv2">
          ...
          <br />● If the card begins or adds to a firework, it will be added to
          that firework pile <br />● If the card does not add to a firework, it
      ...
      <Txt className="mv2">
        ...
        <br />● If you get the third red token, you lose the game as the display
        goes up in flames!
        <br />● If the team completes all five colors of firework with a value
        of 5, the team makes a spectacular victory display and obtains the
        maximum score of 25 points - 30 with multicolor option!
        <br /> ● If a player draws the last card from deck, the game is almost
        over. Each player gets one more turn, including the player who drew the
        last card. Players cannot draw more cards during these final turns.
        <br />
        <br />
